...
function renameColumn(element, currentFile, processModel, logger, vfs) {
    ...
    )
    {
        // Rule R01 ---->
        // Trace ---->
        logger.info(`renameColumn - 20230611.133232 - 1 / 3 - ${currentFile} - ${JSON.stringify(processModel)}`)
        // Trace <----
    ...
    )
    {
        // Rule R02 ---->
        // Trace ---->
        logger.info(`renameColumn - 20230611.133232 - 2 / 3 - ${currentFile} - ${JSON.stringify(processModel)}`)
        // Trace <----
    ...
    else
    {
        // Rule R03 ---->
        // Trace ---->
        logger.info(`renameColumn - 20230611.133232 - 3 / 3 - ${currentFile} - ${JSON.stringify(processModel)}`)
        // Trace <----
        // Action A02: error
        logger.error(`renameColumn - 20230611.133232 - Format for ${currentFile} is not supported.`)
        // Rule R03 <----
    }
