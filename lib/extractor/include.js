...
function include(element, currentFile, processModel, logger, vfs) {
    ...
    )
    {
        ...
        )
        {
            // Rule R01 ---->
            // Trace ---->
            logger.info(`include - 20230611.145920 - 1 / 7 - ${currentFile} - ${JSON.stringify(processModel)}`)
            // Trace <----
        ...
        )
        {
            // Rule R02 ---->
            // Trace ---->
            logger.info(`include - 20230611.145920 - 2 / 7 - ${currentFile} - ${JSON.stringify(processModel)}`)
            // Trace <----
            // Action A02/04: error / MFNS / Mixed liquibase base definitions is not supported.
            logger.error(`include - 20230611.145920 - 2 / 7 - Mixed liquibase base definitions is not supported.`)
            // Rule R02 <----
        }
        else
        {
            // Rule R03 ---->
            // Trace ---->
            logger.info(`include - 20230611.145920 - 3 / 7 - ${currentFile} - ${JSON.stringify(processModel)}`)
            // Trace <----
            // Action A02/02: error / UYFE / YAML liquibase definition unknown file extension.
            logger.error(`include - 20230611.145920 - 3 / 7 - YAML liquibase definition unknown file extension.`)
            // Rule R03 <----
        }
    ...
    )
    {
        ...
        )
        {
            // Rule R04 ---->
            // Trace ---->
            logger.info(`include - 20230611.145920 - 4 / 7 - ${currentFile} - ${JSON.stringify(processModel)}`)
            // Trace <----
            // Action A02/04: error / MFNS / Mixed liquibase base definitions is not supported.
            logger.error(`include - 20230611.145920 - 4 / 7 - Mixed liquibase base definitions is not supported.`)
            // Rule R04 <----
        ...
        )
        {
            // Rule R05 ---->
            // Trace ---->
            logger.info(`include - 20230611.145920 - 5 / 7 - ${currentFile} - ${JSON.stringify(processModel)}`)
            // Trace <----
        ...
        else
        {
            // Rule R06 ---->
            // Trace ---->
            logger.info(`include - 20230611.145920 - 6 / 7 - ${currentFile} - ${JSON.stringify(processModel)}`)
            // Trace <----
            // Action A02/03: error / UXFE / XML liquibase defintion unknown file extension.
            logger.error(`include - 20230611.145920 - 6 / 7 - XML liquibase defintion unknown file extension.`)
            // Rule R06 <----
        }
    }
    else
    {
        // Rule R07 ---->
        // Trace ---->
        logger.info(`include - 20230611.145920 - 7 / 7 - ${currentFile} - ${JSON.stringify(processModel)}`)
        // Trace <----
        // Action A02/01: error / UDF / Format for '${currentFile}' is not supported.
        logger.error(`include - 20230611.145920 - 7 / 7 - Format for '${currentFile}' is not supported.`)
        // Rule R07 <----
    }
