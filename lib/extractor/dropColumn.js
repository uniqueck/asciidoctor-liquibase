...
function dropColumn(element, currentFile, processModel, logger, vfs) {
    ...
    )
    {
        ...
        // Trace ---->
        logger.info(`dropColumn - 20230611.153614 - 1 / 3 - ${currentFile} - ${JSON.stringify(processModel)}`)
        // Trace <----
    ...
    )
    {
        ...
        // Trace ---->
        logger.info(`dropColumn - 20230611.153614 - 2 / 3 - ${currentFile} - ${JSON.stringify(processModel)}`)
        // Trace <----
    ...
    else
    {
        ...
        // Trace ---->
        logger.info(`dropColumn - 20230611.153614 - 3 / 3 - ${currentFile} - ${JSON.stringify(processModel)}`)
        // Trace <----
        
        // Action A02: error
        logger.error(`dropColumn - 20230611.153614 - Format for ${currentFile} is not supported.`)
