...
function addForeignKeyConstraint(element, currentFile, processModel, logger, vfs) {
    ...
    )
    {
        // Rule R01 ---->
        // Trace ---->
        logger.info(`addForeignKeyConstraint - 20230611.133423 - 1 / 3 - ${currentFile} - ${JSON.stringify(processModel)}`)
        // Trace <----
    ...
    )
    {
        // Rule R02 ---->
        // Trace ---->
        logger.info(`addForeignKeyConstraint - 20230611.133423 - 2 / 3 - ${currentFile} - ${JSON.stringify(processModel)}`)
        // Trace <----
    ...
    else
    {
        // Rule R03 ---->
        // Trace ---->
        logger.info(`addForeignKeyConstraint - 20230611.133423 - 3 / 3 - ${currentFile} - ${JSON.stringify(processModel)}`)
        // Trace <----
        // Action A02: error
        logger.error(`addForeignKeyConstraint - 20230611.133423 - Format for ${currentFile} is not supported.`)
        // Rule R03 <----
    }
