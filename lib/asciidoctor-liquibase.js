...
function liquibaseBlockMacro (name, context) {
    ...
    )
    {
        ...
        )
        {
            // Rule R01 ---->
            // Trace ---->
            logger.info('asciidoctor-liquibase - 20230616.120327 - 1 / 4')
            // Trace <----
        ...
        )
        {
            // Rule R02 ---->
            // Trace ---->
            logger.info('asciidoctor-liquibase - 20230616.120327 - 2 / 4')
            // Trace <----
        ...
        else
        {
            // Rule R03 ---->
            // Trace ---->
            logger.info('asciidoctor-liquibase - 20230616.120327 - 3 / 4')
            // Trace <----
    ...
    else
    {
        // Rule R04 ---->
        // Trace ---->
        logger.info('asciidoctor-liquibase - 20230616.120327 - 4 / 4')
        // Trace <----
