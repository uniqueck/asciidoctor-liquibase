...
function include(element, currentFile, processModel, logger, vfs) {
    ...
    )
    {
        ...
        )
        {
            ...
            // Trace ---->
            logger.info(`include - 20230616.185319 - 1 / 7 - ${currentFile} - ${JSON.stringify(processModel)}`)
            // Trace <----
        ...
        )
        {
            ...
            // Trace ---->
            logger.info(`include - 20230616.185319 - 2 / 7 - ${currentFile} - ${JSON.stringify(processModel)}`)
            // Trace <----
            
            // Action A02/04: error / MFNS / Mixed liquibase base definitions is not supported.
            logger.error(`include - 20230616.185319 - 2 / 7 - Mixed liquibase base definitions is not supported.`)
        ...
        else
        {
            ...
            // Trace ---->
            logger.info(`include - 20230616.185319 - 3 / 7 - ${currentFile} - ${JSON.stringify(processModel)}`)
            // Trace <----
            
            // Action A02/02: error / UYFE / YAML liquibase definition unknown file extension.
            logger.error(`include - 20230616.185319 - 3 / 7 - YAML liquibase definition unknown file extension.`)
    ...
    )
    {
        ...
        )
        {
            ...
            // Trace ---->
            logger.info(`include - 20230616.185319 - 4 / 7 - ${currentFile} - ${JSON.stringify(processModel)}`)
            // Trace <----
            
            // Action A02/04: error / MFNS / Mixed liquibase base definitions is not supported.
            logger.error(`include - 20230616.185319 - 4 / 7 - Mixed liquibase base definitions is not supported.`)
        ...
        )
        {
            ...
            // Trace ---->
            logger.info(`include - 20230616.185319 - 5 / 7 - ${currentFile} - ${JSON.stringify(processModel)}`)
            // Trace <----
        ...
        else
        {
            ...
            // Trace ---->
            logger.info(`include - 20230616.185319 - 6 / 7 - ${currentFile} - ${JSON.stringify(processModel)}`)
            // Trace <----
            
            // Action A02/03: error / UXFE / XML liquibase defintion unknown file extension.
            logger.error(`include - 20230616.185319 - 6 / 7 - XML liquibase defintion unknown file extension.`)
    ...
    else
    {
        ...
        // Trace ---->
        logger.info(`include - 20230616.185319 - 7 / 7 - ${currentFile} - ${JSON.stringify(processModel)}`)
        // Trace <----
        
        // Action A02/01: error / UDF / Format for '${currentFile}' is not supported.
        logger.error(`include - 20230616.185319 - 7 / 7 - Format for '${currentFile}' is not supported.`)
