...
function createIndex(element, currentFile, processModel, logger, vfs) {
    ...
    )
    {
        ...
        // Trace ---->
        logger.info(`createIndex - 20230616.185319 - 1 / 2 - ${currentFile} - ${JSON.stringify(processModel)}`)
        // Trace <----
    ...
    else
    {
        ...
        // Trace ---->
        logger.info(`createIndex - 20230616.185319 - 2 / 2 - ${currentFile} - ${JSON.stringify(processModel)}`)
        // Trace <----
        
        // Action A02: error
        logger.error(`createIndex - 20230616.185319 - Format for ${currentFile} is not supported.`)
