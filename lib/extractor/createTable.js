...
function createTable(element, currentFile, processModel, logger, vfs) {
    ...
    )
    {
        ...
        // Trace ---->
        logger.info(`createTable - 20230611.153614 - 1 / 3 - ${currentFile} - ${JSON.stringify(processModel)}`)
        // Trace <----
    ...
    )
    {
        ...
        // Trace ---->
        logger.info(`createTable - 20230611.153614 - 2 / 3 - ${currentFile} - ${JSON.stringify(processModel)}`)
        // Trace <----
    ...
    else
    {
        ...
        // Trace ---->
        logger.info(`createTable - 20230611.153614 - 3 / 3 - ${currentFile} - ${JSON.stringify(processModel)}`)
        // Trace <----
        
        // Action A02: error
        logger.error(`createTable - 20230611.153614 - Format for ${currentFile} is not supported.`)
