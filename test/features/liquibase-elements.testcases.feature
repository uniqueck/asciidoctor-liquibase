# Diese Datei wurde erzeugt durch LF-ET 2.2.1 (230620A) und Kommandozeile:
# -GenTest "/opt/data/github/asciidoctor/asciidoctor-liquibase/lfet/liquibase-elements.lfet" -Group "Cucumber" -Config "Config" -NonExecutableRules "50" -RecommendedTestCases -ForceProtocol -OutGherkin "liquibase-elements.testcases.feature" -InputRootfolder "/opt/data/github/asciidoctor/asciidoctor-liquibase/lfet" -OutputRootfolder "/opt/data/github/asciidoctor/asciidoctor-liquibase/test/features"
# 
# Aktueller Benutzer: constantin
# Aktuelles Verzeichnis (user.dir): "/opt/data/github/asciidoctor/asciidoctor-liquibase"
# Benötigte Zeit: 00:00:00.295 (09.07.2023 13:45:34.877 - 09.07.2023 13:45:35.172)
# 
...
# Informationen: 1
# 
#     1. Entscheidungstabelle: /opt/data/github/asciidoctor/asciidoctor-liquibase/lfet/liquibase-elements.lfet
#          Verknüpfung: *GTD.Formats - /opt/data/github/asciidoctor/asciidoctor-liquibase/test/features/liquibase-elements.gtd.txt
#            Erfolgreich eingelesen: Formats, 2 Sätze, Encoding UTF-8
...
Feature: Analyze Liquibase element based on name
  ...
  Scenario: 0028 liquibase-elements
    ...
    Given xml tag value callback function is provided
    *     define xml element name callback function
    *     xml based liquibase element name is 'hugo'
    When  liquibase-elements is called with tillTag 'V1.0.0'
