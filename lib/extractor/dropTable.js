...
function dropTable(element, currentFile, processModel, logger, vfs) {
    ...
    )
    {
        // Rule R01 ---->
        // Trace ---->
        logger.info(`dropTable - 20230611.130544 - 1 / 3 - ${currentFile} - ${JSON.stringify(processModel)}`)
        // Trace <----
    ...
    )
    {
        // Rule R02 ---->
        // Trace ---->
        logger.info(`dropTable - 20230611.130544 - 2 / 3 - ${currentFile} - ${JSON.stringify(processModel)}`)
        // Trace <----
    ...
    else
    {
        // Rule R03 ---->
        // Trace ---->
        logger.info(`dropTable - 20230611.130544 - 3 / 3 - ${currentFile} - ${JSON.stringify(processModel)}`)
        // Trace <----
        // Action A02: error
        logger.errror('dass')
        // Rule R03 <----
