...
function liquibaseElement(element, logger, tillTag, elementNameCallback, tagValueCallback) {
  ...
  let liquibaseElementResult = {}
    // Prolog Decision Table <----
    // Condition B01/01: Liquibase element name is ... / addDefaultValue / liquibase element addDefaultValue
    if (
    elementNameCallback(element, 'addDefaultValue')
    )
    {
        // Rule R01 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230616.190249 - 1 / 28 - ${JSON.stringify(element)}`)
        // Trace <----
    ...
    elementNameCallback(element, 'loadData')
    )
    {
        // Rule R02 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230616.190249 - 2 / 28 - ${JSON.stringify(element)}`)
        // Trace <----
        // Action A01/02: log / IGNORE / ignored element
        logger.info(`Liquibase element '${JSON.stringify(element)}' ignored`)
        // Action A02/01: set element to ignore / true / element should ignored
    ...
    elementNameCallback(element, 'insert')
    )
    {
        // Rule R03 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230616.190249 - 3 / 28 - ${JSON.stringify(element)}`)
        // Trace <----
        // Action A01/02: log / IGNORE / ignored element
        logger.info(`Liquibase element '${JSON.stringify(element)}' ignored`)
        // Action A02/01: set element to ignore / true / element should ignored
    ...
    elementNameCallback(element, 'sql')
    )
    {
        // Rule R04 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230616.190249 - 4 / 28 - ${JSON.stringify(element)}`)
        // Trace <----
        // Action A01/02: log / IGNORE / ignored element
        logger.info(`Liquibase element '${JSON.stringify(element)}' ignored`)
        // Action A02/01: set element to ignore / true / element should ignored
    ...
    elementNameCallback(element, 'sqlFile')
    )
    {
        // Rule R05 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230616.190249 - 5 / 28 - ${JSON.stringify(element)}`)
        // Trace <----
        // Action A01/02: log / IGNORE / ignored element
        logger.info(`Liquibase element '${JSON.stringify(element)}' ignored`)
        // Action A02/01: set element to ignore / true / element should ignored
    ...
    elementNameCallback(element, 'preConditions')
    )
    {
        // Rule R06 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230616.190249 - 6 / 28 - ${JSON.stringify(element)}`)
        // Trace <----
        // Action A01/02: log / IGNORE / ignored element
        logger.info(`Liquibase element '${JSON.stringify(element)}' ignored`)
        // Action A02/01: set element to ignore / true / element should ignored
    ...
    elementNameCallback(element, 'property')
    )
    {
        // Rule R07 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230616.190249 - 7 / 28 - ${JSON.stringify(element)}`)
        // Trace <----
        // Action A01/02: log / IGNORE / ignored element
        logger.info(`Liquibase element '${JSON.stringify(element)}' ignored`)
        // Action A02/01: set element to ignore / true / element should ignored
    ...
    elementNameCallback(element, 'tagDatabase')
    )
    {
        // Condition B02: tag = tillTag
        if (
        tillTag === tagValueCallback(element)
        )
        {
            // Rule R08 ---->
            // Trace ---->
            logger.info(`liquibase-elements - 20230616.190249 - 8 / 28 - ${JSON.stringify(element)}`)
            // Trace <----
        ...
        else
        {
            // Rule R09 ---->
            // Trace ---->
            logger.info(`liquibase-elements - 20230616.190249 - 9 / 28 - ${JSON.stringify(element)}`)
            // Trace <----
            // Action A02/01: set element to ignore / true / element should ignored
            liquibaseElementResult.ignore = true
            // Action A03/02: set finish processing / false / parsing is not yet done
    ...
    elementNameCallback(element, 'addForeignKeyConstraint')
    )
    {
        // Rule R10 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230616.190249 - 10 / 28 - ${JSON.stringify(element)}`)
        // Trace <----
        // Action A02/02: set element to ignore / false / element should processed
        liquibaseElementResult.ignore = false
        // Action A03/02: set finish processing / false / parsing is not yet done
    ...
    elementNameCallback(element, 'addUniqueConstraint')
    )
    {
        // Rule R11 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230616.190249 - 11 / 28 - ${JSON.stringify(element)}`)
        // Trace <----
        // Action A01/02: log / IGNORE / ignored element
        logger.info(`Liquibase element '${JSON.stringify(element)}' ignored`)
        // Action A02/01: set element to ignore / true / element should ignored
    ...
    elementNameCallback(element, 'rollback')
    )
    {
        // Rule R12 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230616.190249 - 12 / 28 - ${JSON.stringify(element)}`)
        // Trace <----
        // Action A01/02: log / IGNORE / ignored element
        logger.info(`Liquibase element '${JSON.stringify(element)}' ignored`)
        // Action A02/01: set element to ignore / true / element should ignored
    ...
    elementNameCallback(element, 'dropColumn')
    )
    {
        // Rule R13 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230616.190249 - 13 / 28 - ${JSON.stringify(element)}`)
        // Trace <----
        // Action A02/02: set element to ignore / false / element should processed
        liquibaseElementResult.ignore = false
        // Action A03/02: set finish processing / false / parsing is not yet done
    ...
    elementNameCallback(element, 'addColumn')
    )
    {
        // Rule R14 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230616.190249 - 14 / 28 - ${JSON.stringify(element)}`)
        // Trace <----
        // Action A02/02: set element to ignore / false / element should processed
        liquibaseElementResult.ignore = false
        // Action A03/02: set finish processing / false / parsing is not yet done
    ...
    elementNameCallback(element, 'comment')
    )
    {
        // Rule R15 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230616.190249 - 15 / 28 - ${JSON.stringify(element)}`)
        // Trace <----
        // Action A01/02: log / IGNORE / ignored element
        logger.info(`Liquibase element '${JSON.stringify(element)}' ignored`)
        // Action A02/01: set element to ignore / true / element should ignored
    ...
    elementNameCallback(element, 'renameColumn')
    )
    {
        // Rule R16 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230616.190249 - 16 / 28 - ${JSON.stringify(element)}`)
        // Trace <----
        // Action A02/02: set element to ignore / false / element should processed
        liquibaseElementResult.ignore = false
        // Action A03/02: set finish processing / false / parsing is not yet done
    ...
    elementNameCallback(element, 'createIndex')
    )
    {
        // Rule R17 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230616.190249 - 17 / 28 - ${JSON.stringify(element)}`)
        // Trace <----
        // Action A02/02: set element to ignore / false / element should processed
        liquibaseElementResult.ignore = false
        // Action A03/02: set finish processing / false / parsing is not yet done
    ...
    elementNameCallback(element, 'changeSet')
    )
    {
        // Rule R18 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230616.190249 - 18 / 28 - ${JSON.stringify(element)}`)
        // Trace <----
        // Action A02/02: set element to ignore / false / element should processed
        liquibaseElementResult.ignore = false
        // Action A03/02: set finish processing / false / parsing is not yet done
    ...
    elementNameCallback(element, 'dropSequence')
    )
    {
        // Rule R19 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230616.190249 - 19 / 28 - ${JSON.stringify(element)}`)
        // Trace <----
        // Action A01/02: log / IGNORE / ignored element
        logger.info(`Liquibase element '${JSON.stringify(element)}' ignored`)
        // Action A02/01: set element to ignore / true / element should ignored
    ...
    elementNameCallback(element, 'createTable')
    )
    {
        // Rule R20 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230616.190249 - 20 / 28 - ${JSON.stringify(element)}`)
        // Trace <----
        // Action A02/02: set element to ignore / false / element should processed
        liquibaseElementResult.ignore = false
        // Action A03/02: set finish processing / false / parsing is not yet done
    ...
    elementNameCallback(element, 'addPrimaryKey')
    )
    {
        // Rule R21 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230616.190249 - 21 / 28 - ${JSON.stringify(element)}`)
        // Trace <----
        // Action A02/02: set element to ignore / false / element should processed
        liquibaseElementResult.ignore = false
        // Action A03/02: set finish processing / false / parsing is not yet done
    ...
    elementNameCallback(element, 'dropTable')
    )
    {
        // Rule R22 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230616.190249 - 22 / 28 - ${JSON.stringify(element)}`)
        // Trace <----
        // Action A02/02: set element to ignore / false / element should processed
        liquibaseElementResult.ignore = false
        // Action A03/02: set finish processing / false / parsing is not yet done
    ...
    elementNameCallback(element, 'include')
    )
    {
        // Rule R23 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230616.190249 - 23 / 28 - ${JSON.stringify(element)}`)
        // Trace <----
        // Action A02/02: set element to ignore / false / element should processed
        liquibaseElementResult.ignore = false
        // Action A03/02: set finish processing / false / parsing is not yet done
    ...
    elementNameCallback(element, 'createSequence')
    )
    {
        // Rule R24 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230616.190249 - 24 / 28 - ${JSON.stringify(element)}`)
        // Trace <----
        // Action A01/02: log / IGNORE / ignored element
        logger.info(`Liquibase element '${JSON.stringify(element)}' ignored`)
        // Action A02/01: set element to ignore / true / element should ignored
    ...
    elementNameCallback(element, 'createProcedure')
    )
    {
        // Rule R25 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230616.190249 - 25 / 28 - ${JSON.stringify(element)}`)
        // Trace <----
        // Action A01/02: log / IGNORE / ignored element
        logger.info(`Liquibase element '${JSON.stringify(element)}' ignored`)
        // Action A02/01: set element to ignore / true / element should ignored
    ...
    elementNameCallback(element, 'modifyDataType')
    )
    {
        // Rule R26 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230616.190249 - 26 / 28 - ${JSON.stringify(element)}`)
        // Trace <----
        // Action A02/02: set element to ignore / false / element should processed
        liquibaseElementResult.ignore = false
        // Action A03/02: set finish processing / false / parsing is not yet done
    ...
    elementNameCallback(element, 'update')
    )
    {
        // Rule R27 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230616.190249 - 27 / 28 - ${JSON.stringify(element)}`)
        // Trace <----
        // Action A01/02: log / IGNORE / ignored element
        logger.info(`Liquibase element '${JSON.stringify(element)}' ignored`)
        // Action A02/01: set element to ignore / true / element should ignored
    ...
    else
    {
        // Rule R28 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230616.190249 - 28 / 28 - ${JSON.stringify(element)}`)
        // Trace <----
