...
function dropTable(element, currentFile, processModel, logger, vfs) {
    ...
    )
    {
        ...
        // Trace ---->
        logger.info(`dropTable - 20230611.153614 - 1 / 3 - ${currentFile} - ${JSON.stringify(processModel)}`)
        // Trace <----
    ...
    )
    {
        ...
        // Trace ---->
        logger.info(`dropTable - 20230611.153614 - 2 / 3 - ${currentFile} - ${JSON.stringify(processModel)}`)
        // Trace <----
    ...
    else
    {
        ...
        // Trace ---->
        logger.info(`dropTable - 20230611.153614 - 3 / 3 - ${currentFile} - ${JSON.stringify(processModel)}`)
        // Trace <----
