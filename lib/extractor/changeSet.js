...
function changeSet(element, currentFile, processModel, logger, vfs) {
    ...
    )
    {
        ...
        )
        {
            ...
            // Trace ---->
            logger.info(`changeSet - 20230616.120700 - 1 / 4 - ${currentFile} - ${JSON.stringify(processModel)}`)
            // Trace <----
        ...
        else
        {
            ...
            // Trace ---->
            logger.info(`changeSet - 20230616.120700 - 2 / 4 - ${currentFile} - ${JSON.stringify(processModel)}`)
            // Trace <----
    ...
    )
    {
        ...
        // Trace ---->
        logger.info(`changeSet - 20230616.120700 - 3 / 4 - ${currentFile} - ${JSON.stringify(processModel)}`)
        // Trace <----
    ...
    else
    {
        ...
        // Trace ---->
        logger.info(`changeSet - 20230616.120700 - 4 / 4 - ${currentFile} - ${JSON.stringify(processModel)}`)
        // Trace <----
        
        // Action A02: error
        logger.error(`changeSet - 20230616.120700 - Format for ${currentFile} is not supported.`)
