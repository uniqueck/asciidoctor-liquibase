  ...
  do {
    ...
    if (_step === 1) {
      ...
      if (elementIndex < elements.length) {
        ...
        if (currentFile.endsWith('xml')) {
          // Rule R01 ---->
          // Trace ---->
          logger.info(`liquibase-parser - 20230831.202146 - 1 / 9 - ${currentFile} - ${JSON.stringify(processModel)}`)
          // Trace <----
        ...
        // Condition B05/02: changeset format / yaml / yaml based changeset definitions
          ...
          // Rule R02 ---->
          // Trace ---->
          logger.info(`liquibase-parser - 20230831.202146 - 2 / 9 - ${currentFile} - ${JSON.stringify(processModel)}`)
          // Trace <----
          ...
          // Rule R03 ---->
          // Trace ---->
          logger.info(`liquibase-parser - 20230831.202146 - 3 / 9 - ${currentFile} - ${JSON.stringify(processModel)}`)
          // Trace <----
        ...
        // Rule R04 ---->
        // Trace ---->
        logger.info(`liquibase-parser - 20230831.202146 - 4 / 9 - ${currentFile} - ${JSON.stringify(processModel)}`)
        // Trace <----
        // Action A06/02: next Step / Ex / Exit
        _exit = true
        // Rule R04 <----
    ...
    // Condition B01/02: Step / 2 / Step 2
      ...
      if (elementDetails.ignore) {
        // Rule R05 ---->
        // Trace ---->
        logger.info(`liquibase-parser - 20230831.202146 - 5 / 9 - ${currentFile} - ${JSON.stringify(processModel)}`)
        // Trace <----
        ...
        if (processModel.finishedProcessing) {
          // Rule R06 ---->
          // Trace ---->
          logger.info(`liquibase-parser - 20230831.202146 - 6 / 9 - ${currentFile} - ${JSON.stringify(processModel)}`)
          // Trace <----
          // Action A06/02: next Step / Ex / Exit
          _exit = true
          // Rule R06 <----
          ...
          // Rule R07 ---->
          // Trace ---->
          logger.info(`liquibase-parser - 20230831.202146 - 7 / 9 - ${currentFile} - ${JSON.stringify(processModel)}`)
          // Trace <----
      ...
      if (processModel.finishedProcessing) {
        // Rule R08 ---->
        // Trace ---->
        logger.info(`liquibase-parser - 20230831.202146 - 8 / 9 - ${currentFile} - ${JSON.stringify(processModel)}`)
        // Trace <----
        // Action A06/02: next Step / Ex / Exit
        _exit = true
        // Rule R08 <----
        ...
        // Rule R09 ---->
        // Trace ---->
        logger.info(`liquibase-parser - 20230831.202146 - 9 / 9 - ${currentFile} - ${JSON.stringify(processModel)}`)
        // Trace <----
        // Action A06/03: next Step / 1 / Step 1
        _step = 1
        _exit = false
