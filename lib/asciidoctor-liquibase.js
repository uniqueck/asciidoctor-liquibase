...
function liquibaseBlockMacro (name, context) {
    ...
    // Condition B01/01: changeset format / xml / xml based changeset definitions
    if (
    ...
    )
    {
        ...
        // Trace ---->
        logger.info('asciidoctor-liquibase - 20230521.121905 - 1 / 2')
        // Trace <----
        ...
        require('./liquibase-xml-parser.js').parseLiquibaseChangeSet(processModel, changelogFile, elements, logger, vfs, tillTag)
    ...
    else
    {
        ...
        // Trace ---->
        logger.info('asciidoctor-liquibase - 20230521.121905 - 2 / 2')
        // Trace <----
