...
function changeSet(element, currentFile, processModel, logger, vfs) {
    ...
    )
    {
        ...
        )
        {
            ...
            // Trace ---->
            logger.info(`changeSet - 20230616.185319 - 1 / 4 - ${currentFile} - ${JSON.stringify(processModel)}`)
            // Trace <----
        ...
        else
        {
            ...
            // Trace ---->
            logger.info(`changeSet - 20230616.185319 - 2 / 4 - ${currentFile} - ${JSON.stringify(processModel)}`)
            // Trace <----
    ...
    )
    {
        ...
        // Trace ---->
        logger.info(`changeSet - 20230616.185319 - 3 / 4 - ${currentFile} - ${JSON.stringify(processModel)}`)
        // Trace <----
    ...
    else
    {
        ...
        // Trace ---->
        logger.info(`changeSet - 20230616.185319 - 4 / 4 - ${currentFile} - ${JSON.stringify(processModel)}`)
        // Trace <----
        
        // Action A02: error
        logger.error(`changeSet - 20230616.185319 - Format for ${currentFile} is not supported.`)
