      ...
      do {
        ...
        if (_step === 1) {
          ...
          if (changelogFile.endsWith('.xml')) {
            // Rule R01 ---->
            // Trace ---->
            logger.info('asciidoctor-liquibase - 20230826.183758 - 1 / 4')
            // Trace <----
          ...
          // Condition B02/02: changeset format / yaml / yaml based changeset definitions
            ...
            // Rule R02 ---->
            // Trace ---->
            logger.info('asciidoctor-liquibase - 20230826.183758 - 2 / 4')
            // Trace <----
            ...
            // Rule R03 ---->
            // Trace ---->
            logger.info('asciidoctor-liquibase - 20230826.183758 - 3 / 4')
            // Trace <----
          ...
          // Rule R04 ---->
          // Trace ---->
          logger.info('asciidoctor-liquibase - 20230826.183758 - 4 / 4')
          // Trace <----
