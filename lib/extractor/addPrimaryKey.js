...
function addPrimaryKey(element, currentFile, processModel, logger, vfs) {
    ...
    )
    {
        ...
        // Trace ---->
        logger.info(`addPrimaryKey - 20230616.185319 - 1 / 3 - ${currentFile} - ${JSON.stringify(processModel)}`)
        // Trace <----
    ...
    )
    {
        ...
        // Trace ---->
        logger.info(`addPrimaryKey - 20230616.185319 - 2 / 3 - ${currentFile} - ${JSON.stringify(processModel)}`)
        // Trace <----
    ...
    else
    {
        ...
        // Trace ---->
        logger.info(`addPrimaryKey - 20230616.185319 - 3 / 3 - ${currentFile} - ${JSON.stringify(processModel)}`)
        // Trace <----
        
        // Action A02: error
        logger.error(`addPrimaryKey - 20230616.185319 - Format for ${currentFile} is not supported.`)
