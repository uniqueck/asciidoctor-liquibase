...
function liquibaseElement(element, logger, tillTag, elementNameCallback, tagValueCallback) {
  ...
  let liquibaseElementResult = {}
    ...
    )
    {
        // Rule R01 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230610.223314 - 1 / 26 - ${JSON.stringify(element)}`)
        // Trace <----
    ...
    )
    {
        // Rule R02 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230610.223314 - 2 / 26 - ${JSON.stringify(element)}`)
        // Trace <----
        // Action A01/02: log / IGNORE / ignored element
        logger.info(`Liquibase element '${JSON.stringify(element)}' ignored`)
        // Action A02/01: set element to ignore / true / element should ignored
    ...
    )
    {
        // Rule R03 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230610.223314 - 3 / 26 - ${JSON.stringify(element)}`)
        // Trace <----
        // Action A01/02: log / IGNORE / ignored element
        logger.info(`Liquibase element '${JSON.stringify(element)}' ignored`)
        // Action A02/01: set element to ignore / true / element should ignored
    ...
    )
    {
        // Rule R04 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230610.223314 - 4 / 26 - ${JSON.stringify(element)}`)
        // Trace <----
        // Action A01/02: log / IGNORE / ignored element
        logger.info(`Liquibase element '${JSON.stringify(element)}' ignored`)
        // Action A02/01: set element to ignore / true / element should ignored
    ...
    )
    {
        // Rule R05 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230610.223314 - 5 / 26 - ${JSON.stringify(element)}`)
        // Trace <----
        // Action A01/02: log / IGNORE / ignored element
        logger.info(`Liquibase element '${JSON.stringify(element)}' ignored`)
        // Action A02/01: set element to ignore / true / element should ignored
    ...
    )
    {
        // Rule R06 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230610.223314 - 6 / 26 - ${JSON.stringify(element)}`)
        // Trace <----
        // Action A01/02: log / IGNORE / ignored element
        logger.info(`Liquibase element '${JSON.stringify(element)}' ignored`)
        // Action A02/01: set element to ignore / true / element should ignored
    ...
    )
    {
        // Rule R07 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230610.223314 - 7 / 26 - ${JSON.stringify(element)}`)
        // Trace <----
        // Action A01/02: log / IGNORE / ignored element
        logger.info(`Liquibase element '${JSON.stringify(element)}' ignored`)
        // Action A02/01: set element to ignore / true / element should ignored
    ...
    )
    {
        ...
        )
        {
            // Rule R08 ---->
            // Trace ---->
            logger.info(`liquibase-elements - 20230610.223314 - 8 / 26 - ${JSON.stringify(element)}`)
            // Trace <----
        ...
        else
        {
            // Rule R09 ---->
            // Trace ---->
            logger.info(`liquibase-elements - 20230610.223314 - 9 / 26 - ${JSON.stringify(element)}`)
            // Trace <----
            // Action A02/01: set element to ignore / true / element should ignored
            liquibaseElementResult.ignore = true
            // Action A03/02: set finish processing / false / parsing is not yet done
    ...
    )
    {
        // Rule R10 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230610.223314 - 10 / 26 - ${JSON.stringify(element)}`)
        // Trace <----
        // Action A02/02: set element to ignore / false / element should processed
        liquibaseElementResult.ignore = false
        // Action A03/02: set finish processing / false / parsing is not yet done
    ...
    )
    {
        // Rule R11 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230610.223314 - 11 / 26 - ${JSON.stringify(element)}`)
        // Trace <----
        // Action A01/02: log / IGNORE / ignored element
        logger.info(`Liquibase element '${JSON.stringify(element)}' ignored`)
        // Action A02/01: set element to ignore / true / element should ignored
    ...
    )
    {
        // Rule R12 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230610.223314 - 12 / 26 - ${JSON.stringify(element)}`)
        // Trace <----
        // Action A01/02: log / IGNORE / ignored element
        logger.info(`Liquibase element '${JSON.stringify(element)}' ignored`)
        // Action A02/01: set element to ignore / true / element should ignored
    ...
    )
    {
        // Rule R13 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230610.223314 - 13 / 26 - ${JSON.stringify(element)}`)
        // Trace <----
        // Action A02/02: set element to ignore / false / element should processed
        liquibaseElementResult.ignore = false
        // Action A03/02: set finish processing / false / parsing is not yet done
    ...
    )
    {
        // Rule R14 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230610.223314 - 14 / 26 - ${JSON.stringify(element)}`)
        // Trace <----
        // Action A02/02: set element to ignore / false / element should processed
        liquibaseElementResult.ignore = false
        // Action A03/02: set finish processing / false / parsing is not yet done
    ...
    )
    {
        // Rule R15 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230610.223314 - 15 / 26 - ${JSON.stringify(element)}`)
        // Trace <----
        // Action A01/02: log / IGNORE / ignored element
        logger.info(`Liquibase element '${JSON.stringify(element)}' ignored`)
        // Action A02/01: set element to ignore / true / element should ignored
    ...
    )
    {
        // Rule R16 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230610.223314 - 16 / 26 - ${JSON.stringify(element)}`)
        // Trace <----
        // Action A02/02: set element to ignore / false / element should processed
        liquibaseElementResult.ignore = false
        // Action A03/02: set finish processing / false / parsing is not yet done
        liquibaseElementResult.finshedProcessing = false
        // Action A04/10: set element name / renameColumn / liquibase element renameColumn
    ...
    )
    {
        // Rule R17 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230610.223314 - 17 / 26 - ${JSON.stringify(element)}`)
        // Trace <----
        // Action A02/02: set element to ignore / false / element should processed
        liquibaseElementResult.ignore = false
        // Action A03/02: set finish processing / false / parsing is not yet done
    ...
    )
    {
        // Rule R18 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230610.223314 - 18 / 26 - ${JSON.stringify(element)}`)
        // Trace <----
        // Action A02/02: set element to ignore / false / element should processed
        liquibaseElementResult.ignore = false
        // Action A03/02: set finish processing / false / parsing is not yet done
    ...
    )
    {
        // Rule R19 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230610.223314 - 19 / 26 - ${JSON.stringify(element)}`)
        // Trace <----
        // Action A01/02: log / IGNORE / ignored element
        logger.info(`Liquibase element '${JSON.stringify(element)}' ignored`)
        // Action A02/01: set element to ignore / true / element should ignored
    ...
    )
    {
        // Rule R20 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230610.223314 - 20 / 26 - ${JSON.stringify(element)}`)
        // Trace <----
        // Action A02/02: set element to ignore / false / element should processed
        liquibaseElementResult.ignore = false
        // Action A03/02: set finish processing / false / parsing is not yet done
    ...
    )
    {
        // Rule R21 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230610.223314 - 21 / 26 - ${JSON.stringify(element)}`)
        // Trace <----
        // Action A02/02: set element to ignore / false / element should processed
        liquibaseElementResult.ignore = false
        // Action A03/02: set finish processing / false / parsing is not yet done
    ...
    )
    {
        // Rule R22 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230610.223314 - 22 / 26 - ${JSON.stringify(element)}`)
        // Trace <----
        // Action A02/02: set element to ignore / false / element should processed
        liquibaseElementResult.ignore = false
        // Action A03/02: set finish processing / false / parsing is not yet done
    ...
    )
    {
        // Rule R23 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230610.223314 - 23 / 26 - ${JSON.stringify(element)}`)
        // Trace <----
        // Action A02/02: set element to ignore / false / element should processed
        liquibaseElementResult.ignore = false
        // Action A03/02: set finish processing / false / parsing is not yet done
    ...
    )
    {
        // Rule R24 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230610.223314 - 24 / 26 - ${JSON.stringify(element)}`)
        // Trace <----
        // Action A01/02: log / IGNORE / ignored element
        logger.info(`Liquibase element '${JSON.stringify(element)}' ignored`)
        // Action A02/01: set element to ignore / true / element should ignored
    ...
    )
    {
        // Rule R25 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230610.223314 - 25 / 26 - ${JSON.stringify(element)}`)
        // Trace <----
        // Action A01/02: log / IGNORE / ignored element
        logger.info(`Liquibase element '${JSON.stringify(element)}' ignored`)
        // Action A02/01: set element to ignore / true / element should ignored
    ...
    else
    {
        // Rule R26 ---->
        // Trace ---->
        logger.info(`liquibase-elements - 20230610.223314 - 26 / 26 - ${JSON.stringify(element)}`)
        // Trace <----
